...
# Create inset colourbar
         ...
         colorbartext= "Cloud top temperature ($^\circ$C)"
...
# Create input dictionary for each map and pass it to the map_cloudtoptemperature function above
   ...
   plt.savefig(dest_dir+"/cloudtoptemperature_"+dom+"_"+date+"_"+time+"_"+map_names[0]+".png", bbox_inches='tight')
