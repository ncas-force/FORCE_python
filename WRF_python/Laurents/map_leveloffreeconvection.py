...
# Create input dictionary for each map and pass it to the map_leveloffreeconvection function above
   ...
   plt.savefig(dest_dir+"/leveloffreeconvection_"+dom+"_"+date+"_"+time+"_"+map_names[0]+".png", bbox_inches='tight')
