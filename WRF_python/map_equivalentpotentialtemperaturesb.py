def map_equivalentpotentialtemperaturesb(x):
   import numpy as np
...
# Plot theta_e
         ...
         theta_e_lvl2 = np.arange(310.0, 340.0, 2.0)
         ...
         theta_e_lvl = np.arange(310.0, 340.0, 1.0)
...
# Create input dictionary for each map and pass it to the map_temperature function above
   ...
   fig = map_equivalentpotentialtemperaturesb(input_dict)

   plt.savefig(dest_dir+"/equivalentpotentialtemperaturesb_"+dom+"_"+date+"_"+time+"_"+level_flag+"_"+map_names[0]+".png", bbox_inches='tight')
