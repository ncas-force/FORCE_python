...
# Create inset colourbar
         ...
         if cbar_inset:
            ...
            if portrait:
               ...
               cbbox.tick_params(axis='both', left=False, top=False, right=False, bottom=False, labelleft=False, labeltop=False, labelright=False, labelbottom=False)
               cbbox.set_facecolor([1,1,1,0.7])
               cbbox.text(0.5,0.18, "1 hour accumulated precipitation (mm)", verticalalignment='center', horizontalalignment='center')
            ...
            if portrait:
               ...
               cbbox.tick_params(axis='both', left=False, top=False, right=False, bottom=False, labelleft=False, labeltop=False, labelright=False, labelbottom=False)
               cbbox.set_facecolor([1,1,1,0.7])
               cbbox.text(0.5,-0.1, "1 hour accumulated precipitation (mm)", verticalalignment='center', horizontalalignment='center')
...
# Create input dictionary for each map and pass it to the map_cloudprecipitation function above
   ...
   plt.savefig(dest_dir+"/cloudprecipitation_"+dom+"_"+date+"_"+time+"_"+map_names[0]+".png", bbox_inches='tight')
