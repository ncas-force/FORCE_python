...
# Create input dictionary for each map and pass it to the map_lcl function above
   ...
   plt.savefig(dest_dir+"/liftingcondensationlevel_"+dom+"_"+date+"_"+time+"_"+map_names[0]+".png", bbox_inches='tight')
