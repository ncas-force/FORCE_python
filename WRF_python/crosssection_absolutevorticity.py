...
# Create input dictionary for each cross section and pass it to the crossection_absolutevorticity function above
   ...
   if fig:
      ...
      plt.savefig(dest_dir+"/absolutevorticity_crosssection_"+dom+"_"+date+"_"+time+"_"+xsection_ids[0]+".png", bbox_inches='tight')
