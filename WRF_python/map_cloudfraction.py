...
# Create input dictionary for each map and pass it to the map_ccloudfraction function above
   input_dict = {}
   ...
   plt.savefig(dest_dir+"/cloudfraction_"+dom+"_"+date+"_"+time+"_"+map_names[0]+".png", bbox_inches='tight')
