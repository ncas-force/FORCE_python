...
# Plot 2m temperature
         T2_lvl = np.arange(5.5, 30.5, 0.25)
...
# Create input dictionary for each map and pass it to the map_2mtemperature function above
   ...
   fig = map_2mtemperaturesb(input_dict)

   plt.savefig(dest_dir+"/2mtemperaturesb_"+dom+"_"+date+"_"+time+"_"+map_names[0]+".png", bbox_inches='tight')
