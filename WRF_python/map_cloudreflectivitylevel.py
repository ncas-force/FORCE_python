def map_cloudreflectivitylevel(x):
...
# Define destination directory
   dest_dir = "/home/earajr/FORCE_WRF_plotting/output/cloudreflectivitylevel"
...
# Loop through maps, create input dictionary for each map and pass it to the map_cloudreflectivitylevel function above
   ...
   for i in np.arange(0, np.shape(limit_lats)[0], 1):
      ...
      fig = map_cloudreflectivitylevel(input_dict)

      plt.savefig(dest_dir+"/cloudreflectivitylevel_"+map_names[i][0]+".png", bbox_inches='tight')
