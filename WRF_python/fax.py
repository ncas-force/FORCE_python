...
# Read sea level pressure and terrain
...
# Save image
      ...
      plt.savefig(dest_dir+"/fax_d0"+str(grid_id)+"_"+sim_start_time['SIMULATION_START_DATE']+"_valid_"+valid_time[0:16]+".png", bbox_inches='tight')
      plt.close()
   
else:
   print("Facsimile charts will only be generated for the external domain")
