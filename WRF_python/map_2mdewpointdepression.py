...
# Loop through maps, create input dictionary for each map and pass it to the map_2mdewpointdepression function above
   ...
   for i in np.arange(0, np.shape(limit_lats)[0], 1):
      ...
      plt.savefig(dest_dir+"/2mdewpointdepression_"+dom+"_"+date+"_"+time+"_"+map_names[i][0]+".png", bbox_inches='tight')
